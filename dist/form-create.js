	...
	function getGlobalApi(fComponent) {
	  ...
	  return {
	    ...
	    changeField: function changeField(field, value) {
	      ...
	      if (handler === undefined) throw new Error("".concat(field, " \u5B57\u6BB5\u4E0D\u5B58\u5728!") + errMsg());else {
	        if (isFunction(value)) value(vm._trueData(field), function (changeValue) {
	          _this.changeField(field, changeValue);
	        });else {
	  ...
	  methods: {
	    ...
	    __init: function __init() {
	      ...
	      this[type].forEach(function (rule, index) {
	        var unWatch = _this3.$watch("".concat(type, ".").concat(index, ".value"), function (n) {
	          if (_this3.trueData[rule.field] === undefined) return unWatch();

	          _this3._changeValue(rule.field, n);
	        });

	        _this3.watchs.push(unWatch);
	      });
	    },
