...
import TreeSelect from '@arco-design/web-vue/es/tree-select';
import '@arco-design/web-vue/es/tree-select/style/css';
import Transfer from '@arco-design/web-vue/es/transfer';
import '@arco-design/web-vue/es/transfer/style/css';
import VerificationCode from '@arco-design/web-vue/es/verification-code';
import '@arco-design/web-vue/es/verification-code/style/css';
...
export default function install(formCreate) {
    formCreate.useApp((_, app) => {
        ...
        app.component(VerificationCode.name) || app.use(VerificationCode);
