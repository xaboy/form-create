...
import {ButtonProps, ColProps, RowProps, TooltipProps, PopupProps, FormItemProps, FormProps} from "tdesign-vue";
...
export interface OptionAttrs {
    ...
    info?: Boolean | Partial<VNodeRule & (TooltipProps | PopupProps) & {
        show?: Boolean;
        native?: Boolean;
        icon?: string;
        align?: 'left' | 'right';
