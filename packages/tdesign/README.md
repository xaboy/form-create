...
> form-create tdsign-vue 动态表单组件
>
> form-create tdsign-vue Dynamic form component

[GitHub](https://github.com/xaboy/form-create) | [文档](http://form-create.com/v3/tdsign-vue/) | [Document](http://form-create.com/en/v2/tdsign-vue/)
