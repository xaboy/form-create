...
export default function FormCreateFactory(config) {
    ...
    function FormCreate(vm) {
        ...
        extend(vm.$options.components, components);
        extend(vm.$options.directives, directives);
    ...
    extend(FormCreate.prototype, {
        ...
        t(id, params, get) {
            ...
            if (value == null && this.vm.$i18n) {
                return this.vm.$i18n.t(id, params);
            }
            if (value == null) {
                value = '';
            }
        ...
        getLocale() {
            ...
            if (this.vm.$i18n && this.vm.$i18n.locale) {
        ...
        setData(id, data, isGlobal) {
            if (!isGlobal) {
                deepSet(this.vm.top.fc.tmpData, id, data);
